...
export const popupEdit = document.querySelector('.pop-up_edit'),
  ...
  popupEditAvatar = document.querySelector('.pop-up_change-avatar'),
  profileEditAvatar = document.querySelector('.profile__edit-avatar'),
  editAvatarFormElement = popupEditAvatar.querySelector('.pop-up__form'),
  // section (wrapper!)
